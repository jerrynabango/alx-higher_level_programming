...
class Rectangle:
    ...
    def __eq__(self, other):
        """Check to see if two instances are equal"""
        return self.area() == other.area()

    def __ne__(self, other):
        """Check to see if two instances are not equal"""
        return self.area() != other.area()

    def __gt__(self, other):
        """Check to see if two instances are greater"""
        return self.area() > other.area()

    def __ge__(self, other):
        """Check to see if two instances are not greater"""
        return self.area() >= other.area()

    def __lt__(self, other):
        """Check to see if two instances are not less"""
        return self.area() < other.area()

    def __le__(self, other):
        """Check to see if two instances are not less than each other"""
        return self.area() <= other.area()
