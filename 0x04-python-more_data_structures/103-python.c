...
/**
 * print_python_bytes - A function that prints information about a bytes object
 *
...
/**
 * print_python_list - A function that prints information about a list of Python objects
 *
